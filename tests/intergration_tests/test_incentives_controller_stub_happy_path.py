...
def test_incentives_controller_stub(
    ...
    steth_reserve_setup.transfer(depositor1, depositor2, deposit2)
    ...
    steth_reserve_setup.withdraw(depositor1)
    ...
    steth_reserve_setup.withdraw(depositor2, deposit2)
